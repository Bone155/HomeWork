    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Card[] card = new Card[10];    // array to store the cards the player is dealt. Reused for each hand
                cardCount = 0;
                int bet = 0;
                ...
                while (total < 21)
                {
                    ...
                    if (command == 'h' || command == 'H')
                    {
                        ...
                        card[cardCount++] = DealCard();
                        PrintCards(card, cardCount);
                        total = CalculateTotal(card, cardCount);
                    }
                    else
                    {
